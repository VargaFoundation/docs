...
const config: Config = {
  ...
  url: 'https://docs.varga.foundation',
  ...
  organizationName: 'vargafoundation', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Varga Foundation`,
    },
    prism: {
